...
public class A3CPythonEnv {
    ...
    private static void A3CcartPole() throws IOException {
        ...
        String envUD = "MountainCar-v0";
        //String envUD = "MountainCarContinuous-v0";
        GymEnv<Encodable, Integer, DiscreteSpace> mdp = new GymEnv<>(envUD, false, false);
