...
public class DQNTest
{
    ...
    public static void main(String[] args) {
        DQNPolicy<HardToyState>  pol = cartPole(); //get a trained agent to play the game.
        loadCartpole(pol); //show off the trained agent.
    }

    private static DQNPolicy<HardToyState> cartPole() {
    ...
    static void loadCartpole(DQNPolicy<HardToyState> pol) {
