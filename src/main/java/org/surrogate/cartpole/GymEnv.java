...
import static org.bytedeco.cpython.global.python.PyEval_InitThreads;
...
import static org.bytedeco.cpython.global.python.PyGILState_Ensure;
import static org.bytedeco.cpython.global.python.PyGILState_Release;
...
import static org.bytedeco.cpython.global.python.PyMem_RawFree;
import static org.bytedeco.cpython.global.python.PyModule_GetDict;
import static org.bytedeco.cpython.global.python.PyRun_StringFlags;
...
import static org.bytedeco.cpython.global.python.Py_AddPath;
...
import static org.bytedeco.cpython.global.python.Py_SetProgramName;
import static org.bytedeco.cpython.global.python.Py_eval_input;
import static org.bytedeco.cpython.global.python.Py_single_input;
...
public class GymEnv<OBSERVATION extends Encodable, A, AS extends ActionSpace<A>> implements MDP<OBSERVATION, A, AS> {
    ...
    public StepReply<OBSERVATION> step(A action) {
        ...
        try {
            ...
            Py_DecRef(PyRun_StringFlags("state, reward, done, info = env.step(" + action +")", Py_single_input, globals, locals, null));
            checkPythonError();
